...
Abstract = {
        ...
        A \gls{qa} benchmark is generated from an example humanities journal to test the agent
        and examine its failure points.
        The thesis concludes,
        that while using a \gls{rag} agent for \gls{ir} works
        there is no inherent benefit to static \gls{ir}
...
Zusammenfassung = {
        ...
        wird ein Frage-Antwort Benchmark am Beispiel einer geisteswissenschaftlichen Fachzeitschrift
        generiert.
        Die Arbeit zeigt, dass während der Ansatz eines \gls{rag} Agent für IR
        funktioniert, es bei den generierten Testbeispielen keinen Vorteil gegenüber eines statischen IR Systems
