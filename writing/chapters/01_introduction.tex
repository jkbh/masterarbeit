...
% TODO Rewrite the introduction, include LLM + Agents + IR -> IR RAG Agent Motivation
...
% TODO Name results for each contribution
...
% TODO More emphasis on AutoGPT, as I will use it later.
...
A model that hallucinates is not feasible in this case. %TODO: explain for LLM hallucination on first mention.
