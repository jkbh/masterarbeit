...
\lstinputlisting[
    style=Code,
    float=tp,
    caption={A chunk produced by the SentenceSplitter that spans two pages.
            The converted PDF plain text contains page titles, numbers,
            footnotes and other additional information besides the main content.
            The information splits the article content into multiple parts.
